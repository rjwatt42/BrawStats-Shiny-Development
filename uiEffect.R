...
effectPanel <- function(prefix="",asTable=FALSE,full=TRUE) {
  ...
  eT1<-tags$table(width = "100%",class="myTable",
                 ...
                 tags$tr(
                   ...
                   tags$td(width = "20%", 
                           numericInput(paste0(prefix,"rIV"), label=NULL,value=braw.def$hypothesis$effect$rIV,min=-1,max=1,step=0.05)
                   ),
                   tags$td(width = "40%"),
                 )
  )
...
eT2<-tags$table(width = "100%",class="myTable",
             ...
             tags$tr(
               ...
               tags$td(width = "20%", 
                       numericInput(paste0(prefix,"rSD"), label=NULL,value=braw.def$hypothesis$effect$rSD,min=-1,max=1,step=0.05)
               )
             ),
             tags$tr(
               tags$td(width = "40%", 
               ...
               tags$td(width = "20%", 
                       conditionalPanel(condition=paste0("input.IV2choice != 'none'"),
                                        numericInput(paste0(prefix,"rIV2"), label = NULL,
                                                     ...
                                                     max = 1,
                                                     step = 0.05,
                                                     value = braw.def$hypothesis$effect$rIV2
                                        ))),
               tags$td(width = "20%",tags$div(style = localStyle, " ")),
               tags$td(width = "20%",tags$div(style = localStyle, " "))
             ),
               ...
               tags$td(width = "20%", 
                       conditionalPanel(condition=paste0("input.IV2choice != 'none'"),
                                        numericInput(paste0(prefix,"rIVIV2"), label = NULL,
                                                     ...
                                                     max = 1,
                                                     step = 0.05,
                                                     value = braw.def$hypothesis$effect$rIVIV2
                                        ))),
               tags$td(width = "20%", tags$div(style = localStyle, " ")),
               tags$td(width = "20%", tags$div(style = localStyle, " "))
               ...
               tags$td(width = "20%",id="IV*IV2", 
                       conditionalPanel(condition=paste0("input.IV2choice != 'none'"),
                                        numericInput(paste0(prefix,"rIVIV2DV"), label = NULL,
                                                     ...
                                                     max = 1,
                                                     step = 0.05,
                                                     value = braw.def$hypothesis$effect$rIVIV2DV
                                        ))),
               tags$td(width = "20%", tags$div(style = localStyle, " ")),
               tags$td(width = "20%", tags$div(style = localStyle, " "))
             ),
